...
🎭 WITH ICON (Lines 115-127)
- Icon before label text
- Custom icon integration

🌍 INTERNATIONALIZATION (Lines 129-145)
- RTL language support
- Arabic text handling
- Icon positioning adjustment

♿ ACCESSIBILITY (Lines 147-152)
- Non-interactive elements
- Color contrast requirements
- Screen reader considerations

💼 COMMON USE CASES (Lines 154-191)
...
🔧 CUSTOMIZATION (Lines 193-204)
- Custom classes and attributes

⚙️ TECHNICAL DETAILS (Lines 206-231)
  ...
  return (
    <div style={{ display: 'flex', gap: '8px', direction: isRTL ? 'rtl' : 'ltr' }}>
      ...
      <Badge 
        ...
        size="large"
      >
        {isRTL ? 'معلومة مهمة' : 'Important Info'}
      </Badge>
    </div>
  );
}
