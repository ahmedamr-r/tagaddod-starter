...
📦 IMPORT & SETUP (Lines 15-30)
- Basic import pattern
- Props documentation

🎯 BASIC USAGE (Lines 31-55)
...
⚙️ BEHAVIOR & CONTROLS (Lines 86-185)
...
🎨 FORMATTING OPTIONS (Lines 186-255)
...
⚡ STATES & VALIDATION (Lines 256-320)
...
♿ ACCESSIBILITY (Lines 511-525)
- Screen reader support, ARIA attributes
- Keyboard navigation

💼 COMMON USE CASES (Lines 526-615)
...
🔧 IMPLEMENTATION DETAILS (Lines 616-665)
...
|------|--------|-----------|--------------|
| xLarge | 56px | 20×20px | 20×20px |
| large | 48px | 18×18px | 18×18px |
| medium | 40px | 16×16px | 16×16px |
| small | 32px | 14×14px | 14×14px |
| xSmall | 28px | 12×12px | 12×12px |
