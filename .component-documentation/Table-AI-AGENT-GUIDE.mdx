...
### 🎛️ TABLE FEATURES (Lines 151-450)
...
### 🎨 VISUAL CONFIGURATION (Lines 451-550)
- Striped vs Non-Striped
- Grid Cells
- Row Hover States
- ScrollArea Integration

### 🔄 STATE MANAGEMENT (Lines 551-650)
- Table States (normal, error, empty, loading, notFound)
- Controlled vs Uncontrolled
- State Synchronization

### 🌍 RTL & INTERNATIONALIZATION (Lines 651-720)
- RTL Detection
- Arabic Text Handling
- Directional Props

### ⚡ ADVANCED PATTERNS (Lines 721-900)
- Server-Side Data Fetching
- Custom State Management
- Performance Optimization

### 🐛 TROUBLESHOOTING (Lines 901-1000)
...
**Visual Display in Filter Bar:**
- Unselected: `[+] Regions [▼]`
- Selected (1): `[×] Regions | 1 selected [▼]`
- Selected (2+): `[×] Regions | 3 selected [▼]`
...
**Visual Display in Filter Bar:**
- Unselected: `[+] Active Filters [▼]`
- Selected: `[×] Active Filters | 3 filters [▼]`
